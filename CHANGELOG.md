...
- Bumped `connexion` from 2.14.2 to 3.0.6 and `Werkzeug` from 2.2.3 to 3.0.3 to resolve
  [SNYK-PYTHON-WERKZEUG-6808933 CVE](https://security.snyk.io/vuln/SNYK-PYTHON-WERKZEUG-6808933)
